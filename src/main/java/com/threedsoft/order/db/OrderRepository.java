...
public interface OrderRepository extends JpaRepository<Order, Long>{
	...
	@Query("select o from Order o inner join fetch o.orderLines ol where o.busName=:busName and o.locnNbr=:locnNbr and o.id=:id")
	public Order findById(@Param("busName") String busName, @Param("locnNbr") Integer locnNbr, @Param("id") Long id);

	@Query("select o from Order o inner join fetch o.orderLines ol where o.busName=:busName and o.locnNbr=:locnNbr and o.company=:company and o.division=:division and o.busUnit=:busUnit")
	...
	@Query("select o from Order o inner join fetch o.orderLines ol where o.busName=:busName and o.locnNbr=:locnNbr and o.orderNbr=:orderNbr")
	...
	@Query("select o from Order o inner join fetch o.orderLines ol where o.busName=:busName and o.locnNbr=:locnNbr and o.id=:orderId")
